    ...
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a>
      <div class="nav-collapse collapse">
        <ul class="nav main-navigation">
            ...
            <ul class="dropdown-menu categories-dropdown">
              <div class="span9">
                <div class="row">
                  ...
                  <!-- BEGIN cat_list-->
                  <div class="span3">
                    <div class="single-cat-dopdown"> <a href="browse.php?id={cat_list.ID}">{cat_list.IMAGE}{cat_list.NAME}</a> </div>
                  </div>
                  <!-- END cat_list -->
                </div>
              </div>
          ...
          <li> <form class="navbar-form pull-right" action="{SITEURL}search.php" method="get">
            <input type="text" class="input-medium" name="q" size="50" value="{Q}">
            <button type="submit" class="btn btn-small" name="sub" value="{L_399}" >Search <i class="icon-search"></i></button>
          </form></li>
        </ul>
      </div>
    </div>
